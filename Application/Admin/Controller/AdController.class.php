...
class AdController extends BackendController
{
    ...
    public function _before_index()
    {
        ...
        if (false === $category_list = F('ad_cate_list_'.$tpl.$cache)) {
            $category_list = D('AdCategory')->ad_cate_cache($tpl, $subsite_id);
        }
    ...
    public function _before_add()
    {
        if ($this->apply['Subsite']) {
            ...
            foreach ($subsite_list as $key => $val) {
                if (false === $data = F('ad_cate_list_'.$val['s_tpl'].'_'.$val['s_id'])) {
                    $data = D('AdCategory')->ad_cate_cache($val['s_tpl'], $val['s_id']);
                }
