    ...
    public function auth()
    {
        ...
        if (IS_POST) {
            ...
            if ((is_array($group_id) && count($group_id) > 0) || (is_array($group_msid) && count($group_msid) > 0)) {
                ...
                $menus = array();
                if (false === $auth_group_list = F('auth_group_list')) {
                    $auth_group_list = D('AdminAuthGroup')->auth_group_list_cache();
                }
            ...
            if (false === $auth_group = F('auth_group')) {
                $auth_group = D('AdminAuthGroup')->auth_group_cache();
            }
