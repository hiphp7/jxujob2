...
class PromotionController extends BackendController
{
    ...
    public function index()
    {
        ...
        if ($key && $key_type>0) {
            switch ($key_type) {
                case 1:
                    $where['j.jobs_name']=array('like','%'.$key.'%');
                    break;
                case 2:
                    $where['j.companyname']=array('like','%'.$key.'%');
                    break;
                case 3:
                    $where['j.id']=array('eq',$key);
                    break;
                case 4:
                    $where['j.company_id']=array('eq',$key);
                    break;
                case 5:
                    $where[$table_name.'.cp_uid']=array('eq',$key);
                    break;
            }
        }
