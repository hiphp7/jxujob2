...
class UploadController extends FrontendController
{
    ...
    public function attach()
    {
        if (IS_POST) {
            ...
            if (!in_array($type, array('resume_img','word_resume','company_logo','company_img','certificate_img'))) {
                return false;
            }
    ...
    protected function word_resume()
    {
        ...
        if ($config_params['upload_ok']) {
            ...
            if (false === $word = $resume_mod->where($where)->getfield('word_resume')) {
