...
class UcenterLib extends Api {
    ...
    public function back() {
        ...
        if (!defined('IN_UC')) {
            ...
            $action = $get['action'];
            require_cache(UCENTER_LIB_PATH . 'Api/uc_client/lib/xml.class.php');
    ...
    static function synlogin($get, $post) {
        $uid = M('Members')->where(array('uc_uid'=>$get['uid']))->getfield('uid');
        if($uid){
